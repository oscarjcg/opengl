...
void SimpleShader::CreateFromFiles(const char* vertexLocation, const char* fragmentLocation)
{
...
std::string SimpleShader::ReadFile(const char* fileLocation)
{
	std::string content;
...
GLuint SimpleShader::GetViewLocation()
{
	return uniformView;
}
GLuint SimpleShader::GetColorLocation()
{
	return uniformColor;
}
